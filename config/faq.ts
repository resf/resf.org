export const about = [
  {
    ...
    <p>We invite all individuals and organizations who believe in this vision to stand with us and be part of this Foundation and Projects.</p>`,
  },
  {
    slug: "resf-rocky",
    question: "Is the RESF and Rocky Linux the same thing?",
    answer: `<p>The RESF is a legal entity that hosts open source projects (such as Rocky Linux).</p>
  ...
  {
    slug: "underlying-principles",
    question: "What are the underlying principles that guide the RESF?",
    answer: `<p>Our guiding principles are: community responsibility, management, and control; ensuring that all dependencies, sources, and build artifacts are free, open source and reproducible; being receptive to adopt and support other projects within the open source community with similar values; transparency in our decision making, organization, and development; enablement of commercial interests in a way that creates a positive feedback loop back into sustainable open source projects and commercialization; and lastly growth and equality of opportunity for individuals and organizations, everyone is welcome.</p>

    <p>Each of these principles are elaborated on within Article II of our charter.</p>
    `,
  },
  {
    slug: "is-resf-nonprofit",
    question: "Is the RESF a non-profit?",
    answer: `<p>The RESF is a self-imposed not-for-profit organization founded as a Delaware Public Benefits Corporation (PBC). We are not a US IRS tax exempt organization as we believe they are not well equipped to protect open source projects nor are they a magic pill for integrity and doing the right thing for the community at large.</p>

    <p>When most people think of a “non-profit” in the US, they usually consider a 501(c)3. These are typically charitable organizations and they are intended to serve the public interest. But it has been harder and harder for open source projects and foundations to obtain a 501(c)3 designation from the IRS which seems to be “<a href="https://web.archive.org/web/20140416105516/https://www.wired.com/2013/06/irs-open-sourc/">struggling with figuring out which of these projects are true to the spirit of 501(c)(3) requirements, and which are simply there to help sell products</a>”. For this reason many projects have instead obtained 501(c)6 designations which are designed to <a href="https://www.irs.gov/pub/irs-tege/eotopick03.pdf">promote common business interests among the corporate sponsors, boards, and members</a>. Couple that with a “pay to play” model of selling of board seats for votes, and you can imagine how it would be possible to pivot control toward a few well funded companies or individuals. We chose not to go that route.</p>

    <p>Should open source projects or Foundations even be US tax exempt? According to Simon Phipps perhaps not, as he describes <a href="https://www.infoworld.com/article/2611441/open-source-projects-aren-t-tax-scams.html?page=2">here</a>; "Maybe the answer is for open source foundations to get out of the nonprofit world. Tax breaks are fine, but they aren’t the primary goal of open source foundations. What matters to their communities is that they have transparent, equal governance that allows everyone to contribute to and benefit from the project without obstruction. The IRS does not warrant that; it’s a matter instead of community scrutiny.”</p>

    <p>We agree and believe that what truly matters for a successful open source community is: transparency, open leadership, dedication to the community, longevity, community accountability, checks and balances, and growth with equal opportunity for everyone.</p>
  ...
  {
    slug: "rl-resf-ciq",
    question: "Does Rocky Linux or the RESF belong to CIQ?",
    answer: `<p>No. The RESF nor the Projects are beholden to any single company.</p>
...
export const BOD = [
  // slug: board-structure (static page)
  {
    ...
    answer: `<p>Unlike many open source foundations, the RESF does not believe in “selling” board seats or votes. All Board Members deserve to be there based on merit, elected by their peers within the community, not who can afford the largest donation.</p>
  ...
  {
    slug: "open-community-voting",
    question: "Why not allow the open community to vote on the boards?",
...
export const projects = [
  ...
  {
    slug: "other-projects-join-resf",
    question: "Why would other Projects want to join the RESF?",
    answer: `<p>There are numerous reasons why open source projects would benefit by being part of the RESF, here are a few for consideration:</p>
...
export const members = [
  ...
  {
    slug: "how-to-become-member",
    question: "How does someone become a member of the RESF?",
    answer: `<p>Becoming a member to the RESF is equivalent to being a member of any Project or Project Team within the RESF. All members are absolutely equal and everybody is welcome; from core developers to non-techies who want to participate in RESF Projects.</p>
