...
import CommunityOperatingPrinciples from "@/components/charter-bylaws/CommunityOperatingPrinciples";
            ...
            <div className="py-16 px-6 sm:py-24 lg:flex lg:justify-between lg:px-8">
              <div>
                ...
                <p className="mt-5 text-xl text-gray-500">
                  ...
                  community operating principles set forth an inclusive
                  management framework, commitment, and accountability to ensure
                  the longevity and success of our hosted open-source projects
            ...
            <div className="px-6 lg:px-8">
              <div className="mx-auto divide-y divide-gray-900/10">
                <dl className="mt-10 space-y-6 divide-y divide-gray-900/10">
                  ...
                  <Disclosure
                    as="div"
                    id="community-operating-principles"
                    className="pt-6"
                  >
                    {({ open }) => (
                      <>
